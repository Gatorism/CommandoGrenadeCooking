...
namespace EntityStates.Commando_Grenade_Cooking
{
    public class CookGrenade : BaseState
    {
        ...
        public static float selfHPDamagePercent = 0.4f; //Remove this fraction of combined HP
        ...
        private void OvercookExplosion()
        {
            ...
            DamageInfo selfDamage = new DamageInfo
            {
                attacker = base.gameObject,
                crit = false,
                damage = base.healthComponent.combinedHealth * CookGrenade.selfHPDamagePercent,
